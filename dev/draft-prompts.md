...
> * *Example:* Does this problem involve heavy string manipulation? -> Opportunity to teach `std::string_view` (Rating 4) vs C# String interning.
...
> **Instructions:**
> 1. **Grounding Search:** Use Google Search to verify any specific algorithms or mathematical constants required by the Spec (e.g., "Sudoku backtracking optimization," "Norvig spell correct probability logic").
